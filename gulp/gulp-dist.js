/**
 * Automatisierung des Buildprozesses fuer Speech-Vue NPM-Package
...
module.exports = ({ gulp, docsDir, bundleDir, srcSpeechDir, buildDir, buildSpeechDir, distDir }) => {
    ...
    gulp.task('dist-replace-index', function() {
        return gulp.src( `${distDir}/index.js` )
            .pipe( replace( '"./const/speech-service-const"', '"./speech-vue"'))
            .pipe( replace( '"./const/speech-service-version"', '"./speech-vue"'))
            .pipe( replace( '"./common/event_emitter"', '"./speech-vue"'))
            .pipe( replace( '"./nuance/nuance-module"', '"./speech-vue"'))
            .pipe( replace( '"./nuance/nuance-service"', '"./speech-vue"'))
            .pipe( replace( '"./amazon/amazon-module"', '"./speech-vue"'))
            .pipe( replace( '"./amazon/amazon-service"', '"./speech-vue"'))
            .pipe( replace( '"./google/google-module"', '"./speech-vue"'))
            .pipe( replace( '"./google/google-service"', '"./speech-vue"'))
            .pipe( replace( '"./microsoft/microsoft-module"', '"./speech-vue"'))
            .pipe( replace( '"./microsoft/microsoft-service"', '"./speech-vue"'))
            .pipe( replace( '"./rasa/rasa-module"', '"./speech-vue"'))
            .pipe( replace( '"./rasa/rasa-service"', '"./speech-vue"'))
            .pipe( replace( '"./base/base-service"', '"./speech-vue"'))
            .pipe( replace( '"./speak/speak-service-const"', '"./speech-vue"'))
            .pipe( replace( '"./speak/speak-service"', '"./speech-vue"'))
            .pipe( replace( '"./listen/listen-service-const"', '"./speech-vue"'))
            .pipe( replace( '"./listen/listen-service"', '"./speech-vue"'))
            .pipe( replace( '"./intent/intent-service-const"', '"./speech-vue"'))
            .pipe( replace( '"./intent/intent-service"', '"./speech-vue"'))
            .pipe( replace( '"./action/action-service"', '"./speech-vue"'))
            .pipe( replace( '"./dialog/dialog-service"', '"./speech-vue"'))
            .pipe( replace( '"./bot/bot-service"', '"./speech-vue"'))
            .pipe( replace( '"./service/service-manager"', '"./speech-vue"'))
            .pipe( gulp.dest( distDir ));
    });
