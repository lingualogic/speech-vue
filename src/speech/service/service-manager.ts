/**
 * Automatisch erzeugte globale service-manager.ts Datei fuer Speech-Vue
 * 
 * Initialisiert und verwaltet alle verfuegbaren Speech-Services.
 *
 * Konfiguration: stable
 * Version: 0.5.23.0011 (release) vom 05.10.2021
 *
 * Speech-Services:
 *
...
/**
 * statische ServiceManager Klasse zur Erzeugung aller Services in Speech-Vue
 *
 * @export
